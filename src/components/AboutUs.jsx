      ...
      >
        <div className="relative z-10 w-full px-5 sm:px-10 md:px-20 flex flex-col md:flex-row items-center gap-12 md:gap-24">
          ...
          <div className="flex-1 min-w-0 w-full">
            <div className="about-eyebrow inline-flex items-center gap-2.5 text-[11px] font-semibold tracking-[0.2em] text-[#89f3ff] uppercase mb-5">
              Who We Are
            </div>
            ...
            <p className="text-base md:text-lg font-light text-white/55 leading-[1.85] max-w-lg">
